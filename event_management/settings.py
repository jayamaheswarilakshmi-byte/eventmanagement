...
# Reads SECRET_KEY from Render Environment Variables, falls back to local key
...
# Connect to Render PostgreSQL if DATABASE_URL environment variable is present
...
EMAIL_HOST_USER = os.environ.get(
    'EMAIL_HOST_USER', 'yourwebsiteemail@gmail.com'
)
